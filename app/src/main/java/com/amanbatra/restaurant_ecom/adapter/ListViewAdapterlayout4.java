...
public class ListViewAdapterlayout4 extends RecyclerView.Adapter<ListViewAdapterlayout4.ViewHolder> {
    private Activity activity;
    private List<RecyclerViewItem> items;

    public ListViewAdapterlayout4(Activity activity, List<RecyclerViewItem> items) {
