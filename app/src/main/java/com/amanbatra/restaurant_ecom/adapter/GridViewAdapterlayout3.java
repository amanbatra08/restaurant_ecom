...
public class GridViewAdapterlayout3 extends RecyclerView.Adapter<GridViewAdapterlayout3.ViewHolder> {
    private List<RecyclerViewItem> items;
    private Activity activity;
    private Animation animi;

    public GridViewAdapterlayout3(Activity activity, List<RecyclerViewItem> items, Animation ani) {
    ...
    @Override
    public void onBindViewHolder(GridViewAdapterlayout3.ViewHolder viewHolder, int position) {
