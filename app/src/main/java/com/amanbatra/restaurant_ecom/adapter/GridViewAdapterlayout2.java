package com.amanbatra.restaurant_ecom.adapter;
...
public class GridViewAdapterlayout2 extends RecyclerView.Adapter<GridViewAdapterlayout2.ViewHolder> {
    private List<RecyclerViewItem> items;
    private Activity activity;
    private Animation animi;

    public GridViewAdapterlayout2(Activity activity, List<RecyclerViewItem> items, Animation ani) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        View view = inflater.inflate(R.layout.item_grid1, viewGroup, false);
        return new ViewHolder(view);
    }

    @SuppressLint("ResourceAsColor")
    @Override
    public void onBindViewHolder(GridViewAdapterlayout2.ViewHolder viewHolder, int position) {
        ...
        public ViewHolder(View view) {
            ...
            imageView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    sgen.viewId = items.get(getAdapterPosition()).getModule3().toString();
