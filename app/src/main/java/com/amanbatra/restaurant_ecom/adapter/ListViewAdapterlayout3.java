...
public class ListViewAdapterlayout3 extends RecyclerView.Adapter<ListViewAdapterlayout3.ViewHolder> {
    private Activity activity;
    private List<RecyclerViewItem> items;

    public ListViewAdapterlayout3(Activity activity, List<RecyclerViewItem> items) {
