...
public class GridViewAdapterlayout1 extends RecyclerView.Adapter<GridViewAdapterlayout1.ViewHolder> {
    private List<RecyclerViewItem> items;
    private Activity activity;
    private Animation animi;

    public GridViewAdapterlayout1(Activity activity, List<RecyclerViewItem> items, Animation ani) {
    ...
    @Override
    public void onBindViewHolder(GridViewAdapterlayout1.ViewHolder viewHolder, int position) {
