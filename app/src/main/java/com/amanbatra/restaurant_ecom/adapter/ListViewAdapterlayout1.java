...
public class ListViewAdapterlayout1 extends RecyclerView.Adapter<ListViewAdapterlayout1.ViewHolder> {
    private Activity activity;
    private List<RecyclerViewItem> items;

    public ListViewAdapterlayout1(Activity activity, List<RecyclerViewItem> items) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.layout_view1, parent, false);
