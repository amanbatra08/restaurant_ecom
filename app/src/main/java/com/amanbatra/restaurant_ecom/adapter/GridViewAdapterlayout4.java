...
public class GridViewAdapterlayout4 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public GridViewAdapterlayout4(Activity activity, List<RecyclerViewItem> items, Animation ani) {
